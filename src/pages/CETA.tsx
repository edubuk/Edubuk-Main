...
export default function WhyCETASection() {
  ...
  return (
    <section className="bg-white text-[#006666] px-6 md:px-20 py-24 border-b border-gray-200" id="ceta">
      ...
      <p className="text-xl text-[#03257e] py-10 font-semibold text-center" data-aos="zoom-in">CETA Program Curriculum is Certified by NSDC (National Skills Development Corporation) under Skills India Mission of Government of India</p>
