...
export const blcLogos =  [blcLogo1,blcLogo2,blcLogo3,blcLogo4,blcLogo5,blcLogo6,blcLogo7];
export const govLogos =  [govLogo1,govLogo2,govLogo3,govLogo4,govLogo5];
export const finLogos =  [finLogo1,finLogo2,finLogo3,finLogo4,finLogo5,finLogo6];
export const foreignLogos = [foreignLogo1,foreignLogo2,foreignLogo3,foreignLogo4,foreignLogo5,foreignLogo6,foreignLogo7];
