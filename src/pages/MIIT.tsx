...
export default function WhyMIITSection() {
  ...
  return (
    <section className="bg-white text-[#006666] px-6 md:px-20 py-6 border-b border-gray-200" id="miit">
      <div className="max-w-6xl mx-auto text-center mb-10">
        ...
        <p className="text-xl mb-4 text-[#03257e] text-left sm:text-justify" data-aos="zoom-in">
          Choosing the right career shouldn't be guesswork. Every student has a
          unique combination of intelligences, interests, and natural abilities
          <span className="text-[#f14419] font-semibold">
            {" "}
            MIIT Screening by Edubuk
          </span>
          , uses a scientific approach to map these traits to the most suitable
          career paths and job roles enabling students to make informed,
          confident, and personalized decisions about their future. Backed by
          research in Multiple Intelligences and Interest Theory, this tool
          empowers youth to align their learning and career planning with who
          they truly are.
        </p>
      </div>
